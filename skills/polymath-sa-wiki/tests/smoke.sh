#!/usr/bin/env bash
# Smoke test for polymath-sa-wiki skill
...
echo "polymath-sa-wiki smoke: checking lark-cli..."
command -v lark-cli >/dev/null || { echo "FAIL: lark-cli not found"; exit 1; }

echo "polymath-sa-wiki smoke: querying knowledge_index (limit 1)..."
...
echo "polymath-sa-wiki smoke: PASS"
