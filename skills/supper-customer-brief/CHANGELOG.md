# supper-customer-brief CHANGELOG

## 0.1.1 — 2026-05-13

- Renamed package to `supper-customer-brief` to adopt the SA Super Skill `supper-` prefix convention.
...
- 4 parallel query agents: supper-sa-wiki (PROFILE+TIMELINE+feedback), local wiki
