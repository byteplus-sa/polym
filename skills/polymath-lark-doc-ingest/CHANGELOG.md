# polymath-lark-doc-ingest CHANGELOG

## 0.1.1 — 2026-05-13

- Renamed package to `polymath-lark-doc-ingest` to adopt the Polymath `polymath-` prefix convention.
...
- Filtering: skip already-ingested (local wiki doc_id check + polymath-sa-wiki knowledge_index);
...
- Lark wiki write via polymath-sa-wiki WRITE workflow (no duplicate logic)
