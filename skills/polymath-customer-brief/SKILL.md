...
# polymath-customer-brief — Pre-Meeting Customer Intelligence
...
```
polymath-customer-brief <customer name>                 # Default: 14-day activity + 3-way query
polymath-customer-brief <customer name> --quick         # Wiki only, ~5 seconds
polymath-customer-brief <customer name> --full          # 4-way including C360, ~20 seconds
polymath-customer-brief <customer name> --days 7        # Custom activity window (default 14)
polymath-customer-brief <customer name> --date tomorrow # Specify meeting date (affects suggestion wording)
```
...
Agent(
  ...
  prompt="""
    ...
    Constants (from polymath-sa-wiki SKILL.md §3):
...
Agent(
  ...
  prompt="""
    ...
    Use polymath-dashboard-watch skill and c360-customer-usage skill pattern.
...
- polymath-sa-wiki SKILL.md §3 (Bitable constants)
- polymath-sa-wiki SKILL.md §4 (READ workflow)
