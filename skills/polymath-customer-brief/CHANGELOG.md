# polymath-customer-brief CHANGELOG

## 0.1.1 — 2026-05-13

- Renamed package to `polymath-customer-brief` to adopt the Polymath `polymath-` prefix convention.
...
- 4 parallel query agents: polymath-sa-wiki (PROFILE+TIMELINE+feedback), local wiki
