# supper-im-digest CHANGELOG

## 0.3.1 — 2026-05-13

- Renamed package to `supper-im-digest` to adopt the SA Super Skill `supper-` prefix convention.
...
- **Lark wiki write delegated to supper-sa-wiki**: Phase 5 now reads supper-sa-wiki SKILL.md §5
...
- Phase 5: Lark wiki write — TIMELINE APPEND + feedback CREATE via supper-sa-wiki write_queue,
