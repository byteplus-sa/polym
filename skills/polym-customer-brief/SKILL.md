...
# polym-customer-brief — Pre-Meeting Customer Intelligence
...
```
polym-customer-brief <customer name>                 # Default: 14-day activity + 3-way query
polym-customer-brief <customer name> --quick         # Wiki only, ~5 seconds
polym-customer-brief <customer name> --full          # 4-way including C360, ~20 seconds
polym-customer-brief <customer name> --days 7        # Custom activity window (default 14)
polym-customer-brief <customer name> --date tomorrow # Specify meeting date (affects suggestion wording)
```
...
Agent(
  ...
  prompt="""
    ...
    Constants (from polym-sa-wiki SKILL.md §3):
...
Agent(
  ...
  prompt="""
    ...
    Use polym-dashboard-watch skill and c360-customer-usage skill pattern.
...
- polym-sa-wiki SKILL.md §3 (Bitable constants)
- polym-sa-wiki SKILL.md §4 (READ workflow)
