...
the detailed browser automation runbook. This file documents how dashboard-watch
calls into it.
...
dashboard-watch delegates all C360 browser automation to the `c360-customer-usage` skill.
