# supper-lark-doc-ingest CHANGELOG

## 0.1.1 — 2026-05-13

- Renamed package to `supper-lark-doc-ingest` to adopt the SA Super Skill `supper-` prefix convention.
...
- Filtering: skip already-ingested (local wiki doc_id check + supper-sa-wiki knowledge_index);
...
- Lark wiki write via supper-sa-wiki WRITE workflow (no duplicate logic)
