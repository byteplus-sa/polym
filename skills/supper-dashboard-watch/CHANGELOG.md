# supper-dashboard-watch CHANGELOG

## 0.1.1 — 2026-05-13

- Renamed package to `supper-dashboard-watch` to adopt the SA Super Skill `supper-` prefix convention.
...
- Local wiki write (silent) + Lark wiki write via supper-sa-wiki (on user confirmation)
