...
the detailed browser automation runbook. This file documents how polymath-dashboard-watch
calls into it.
...
polymath-dashboard-watch delegates all C360 browser automation to the `c360-customer-usage` skill.
