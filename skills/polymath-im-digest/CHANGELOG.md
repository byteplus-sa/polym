# polymath-im-digest CHANGELOG

## 0.3.1 — 2026-05-13

- Renamed package to `polymath-im-digest` to adopt the Polymath `polymath-` prefix convention.
...
- **Lark wiki write delegated to polymath-sa-wiki**: Phase 5 now reads polymath-sa-wiki SKILL.md §5
...
- Phase 5: Lark wiki write — TIMELINE APPEND + feedback CREATE via polymath-sa-wiki write_queue,
